...
var source = [ 'src/init.js', 'src/formatters.js', 'scr/data.js', 'src/config.js', 'src/html-to-json.js', 'src/render.js', 'src/options.js', 'src/chart-manager.js', 'src/chart-collection-manager.js' ];
