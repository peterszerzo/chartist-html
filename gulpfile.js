...
var source = [ 'src/init.js', 'src/data.js', 'src/exists.js', 'src/formatters.js', 'src/config.js', 'src/html-to-json.js', 'src/options.js', 'src/chart-manager.js', 'src/chart-collection-manager.js' ];
